...
angular.module('admin')
	...
	.controller('AdminUsersController', ['$scope', '$state', '$stateParams', '$http', '$location', 'Authentication', 'Admin',
	function($scope, $state, $stateParams, $http, $location, Authentication, Admin) {
